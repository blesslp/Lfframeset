...
public class FlowLayout extends ViewGroup {
    ...
    private int childVerticle;
    private int childHorizontal;
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            this.childVerticle = a.getDimensionPixelSize(R.styleable.FlowLayout_childVerticle, 0);
            this.childHorizontal = a.getDimensionPixelSize(R.styleable.FlowLayout_childHorizontal, 0);
            if (index > 0) {
                setGravity(index);
            }
        } finally {
    ...
    private void changeViews() {
        ...
        if (count > 0) {
            ...
            for (int i = 0; i < count; i++) {
                final View view = adapter.getView(i, getChildAt(i), null);
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        final LayoutParams layoutParams = new LayoutParams(getContext(), attrs);
        layoutParams.rightMargin = childHorizontal;
        layoutParams.bottomMargin = childVerticle;
        return layoutParams;
    }
