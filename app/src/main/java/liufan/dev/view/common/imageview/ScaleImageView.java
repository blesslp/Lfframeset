package liufan.dev.view.common.imageview;
...
public class ScaleImageView extends ImageView {
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        setImageWidth(bm.getWidth());
        setImageHeight(bm.getHeight());
    ...
    public void setImageDrawable(Drawable d) {
        ...
        setImageWidth(d.getIntrinsicWidth());
        setImageHeight(d.getIntrinsicHeight());
        if (imageChangeListener != null)
